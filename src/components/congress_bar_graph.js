/* This component creates a bar graph showing the percent margin of victory in
all 2016 Congressional races ordered from smallest to greatest. Democratic
victors are shown in red, Republican in blue, and all others in grey */
...
export default class congressBarGraph extends Component {
  ...
  render(props) {
    ...
    const independent = {
      label: 'Independent',
      color: '#555555',
      data: getBarData(null, this.props.currentState, this.props.currentDistrict)
    };
    const data = [republican, democrat, independent];

    return (<div className="bargraph-wrapper">
      <h3 className="text-center">Congressional Races Ordered<br/>
        by Margin of Victory</h3>
      <FlexibleWidthXYPlot Xtype="literal" stackBy="y" xDistance={-1} height={380} xDomain={[630, -7]}>
        <HorizontalGridLines/>
